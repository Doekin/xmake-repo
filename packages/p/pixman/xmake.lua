package("pixman")
    ...
    add_versions("git_release:0.46.0", "92c1b08db747ff17f9028da3e63168c8ac23204ce62b1a0437607847c8ad6c36")
    ...
    add_versions("home:0.46.0", "02d9ff7b8458ef61731c3d355f854bbf461fd0a4d3563c51f1c1c7b00638050d")
    ...
    on_install("!android and (!windows or windows|!arm64)", function (package)
